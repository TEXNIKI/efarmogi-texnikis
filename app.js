...
class TechnicalServiceApp {
    ...
    getFundingSpecializations(fundingSource) {
        const specializations = {
            ...
            'pde_ypes_sae055': [
                { value: '0301', label: '0301. ΠΥΡΚΑΓΙΕΣ: Πρόληψη και αντιμετώπιση ζημιών και καταστροφών από πυρκαγιές.' },
                { value: '0302', label: '0302. ΘΕΟΜΗΝΙΕΣ: Πρόληψη και αντιμετώπιση ζημιών και καταστροφών από θεομηνίες.' },
                { value: '0303', label: '0303. ΛΕΙΨΥΔΡΙΑ: Εκτέλεση εργασιών για την αντιμετώπιση του φαινομένου της λειψυδρίας.' },
                { value: '0304', label: '0304. ΣΤΑΘΜΟΙ: Πρασαρμογή βρεφικών, παιδικών και βρεφονηπιακών σταθμών στο ΠΔ 99/2017.' },
                { value: '0305', label: '0305. ΛΟΙΠΑ' }
            ],
            'espa_2014_2020': [
                { value: '0401', label: '0401. ΕΠ ΑΝΕΚ: Ανταγωνιστικότητα, Επιχειρηματικότητα και Καινοτομία' },
                { value: '0402', label: '0402. ΕΠ ΥΜΕΠΕΡΑΑ: Υποδομές Μεταφορών, Περιβάλλον και Αειφόρος Ανάπτυξη' },
                { value: '0403', label: '0403. ΕΠ ΑΝΑΔΕΔΒ: Ανάπτυξη Ανθρώπινου Δυναμικού, Εκπαίδευση και Διά Βίου Μάθηση' },
                { value: '0404', label: '0404. ΕΠ ΜΔΤ: Μεταρρύθμιση Δημόσιου Τομέα' },
                { value: '0405', label: '0405. ΕΠ ΑλΘ: Αλιείας και Θάλασσας' },
                { value: '0406', label: '0406. Επιχειρησιακό Πρόγραμμα Αγροτική Ανάπτυξη' },
                { value: '0407', label: '0407. ΠΕΠ Ανατολικής Μακεδονίας και Θράκης' },
                { value: '0408', label: '0408. ΠΕΠ Αττικής' },
                { value: '0409', label: '0409. ΠΕΠ Βορείου Αιγαίου' },
                { value: '0410', label: '0410. ΠΕΠ Δυτικής Ελλάδας' },
                { value: '0411', label: '0411. ΠΕΠ Δυτικής Μακεδονίας' },
                { value: '0412', label: '0412. ΠΕΠ Ηπείρου' },
                { value: '0413', label: '0413. ΠΕΠ Θεσσαλίας' },
                { value: '0414', label: '0414. ΠΕΠ Ιονίων Νήσων' },
                { value: '0415', label: '0415. ΠΕΠ Κεντρικής Μακεδονίας' },
                { value: '0416', label: '0416. ΠΕΠ Κρήτης' },
                { value: '0417', label: '0417. ΠΕΠ Νοτίου Αιγαίου' },
                { value: '0418', label: '0418. ΠΕΠ Πελοποννήσου' },
                { value: '0419', label: '0419. ΠΕΠ Στερεάς Ελλάδας' },
                { value: '0420', label: '0420. ΕΣΠΑ 2007-2013 (μεταφερόμενο)' },
                { value: '0499', label: '0499. Άλλο (διευκρινίστε στη στήλη ΠΑΡΑΤΗΡΗΣΕΙΣ)' }
            ],
            'espa_2021_2027': [
                { value: '0501', label: '0501. ΕΠ Ανταγωνιστικότητα' },
                { value: '0502', label: '0502. ΕΠ Ψηφιακός μετασχηματισμός' },
                { value: '0503', label: '0503. ΕΠ Περιβάλλον και κλιματική αλλαγή' },
                { value: '0504', label: '0504. ΕΠ Μεταφορές' },
                { value: '0505', label: '0505. ΕΠ Πολιτική προστασία' },
                { value: '0506', label: '0506. ΕΠ Ανθρώπινο δυναμικό και κοινωνική συνοχή' },
                { value: '0507', label: '0507. ΕΠ Δίκαιο αναπτυξιακή μετάβαση' },
                { value: '0508', label: '0508. ΕΠ Αλιεία, υδατοκαλλιέργεια και θάλασσα' },
                { value: '0509', label: '0509. ΠΕΠ Ανατολικής Μακεδονίας και Θράκης' },
                { value: '0510', label: '0510. ΠΕΠ Αττικής' },
                { value: '0511', label: '0511. ΠΕΠ Βορείου Αιγαίου' },
                { value: '0512', label: '0512. ΠΕΠ Δυτικής Ελλάδας' },
                { value: '0513', label: '0513. ΠΕΠ Δυτικής Μακεδονίας' },
                { value: '0514', label: '0514. ΠΕΠ Ηπείρου' },
                { value: '0515', label: '0515. ΠΕΠ Θεσσαλίας' },
                { value: '0516', label: '0516. ΠΕΠ Ιονίων Νήσων' },
                { value: '0517', label: '0517. ΠΕΠ Κεντρικής Μακεδονίας' },
                { value: '0518', label: '0518. ΠΕΠ Κρήτης' },
                { value: '0519', label: '0519. ΠΕΠ Νοτίου Αιγαίου' },
                { value: '0520', label: '0520. ΠΕΠ Πελοποννήσου' },
                { value: '0521', label: '0521. ΠΕΠ Στερεάς Ελλάδας' },
                { value: '0599', label: '0599. Άλλο (διευκρινίστε στη στήλη ΠΑΡΑΤΗΡΗΣΕΙΣ)' }
            ],
            'ethniko_pde': [
                { value: '0601', label: '0601. Υπουργείο Οικονομικών' },
                { value: '0602', label: '0602. Υπουργείο Ανάπτυξης & Επενδύσεων' },
                { value: '0603', label: '0603. Υπουργείο Παιδείας & Θρησκευμάτων' },
                { value: '0604', label: '0604. Υπουργείο Εργασίας & Κοινωνικών Υποθέσεων' },
                { value: '0605', label: '0605. Υπουργείο Υγείας' },
                { value: '0606', label: '0606. Υπουργείο Περιβάλλοντος & Ενέργειας' },
                { value: '0607', label: '0607. Υπουργείο Προστασίας του Πολίτη' },
                { value: '0608', label: '0608. Υπουργείο Πολιτισμού & Αθλητισμού' },
                { value: '0609', label: '0609. Υπουργείο Εσωτερικών' },
                { value: '0610', label: '0610. Υπουργείο Μετανάστευσης και Ασύλου' },
                { value: '0611', label: '0611. Υπουργείο Ψηφιακής Διακυβέρνησης' },
                { value: '0612', label: '0612. Υπουργείο Υποδομών & Μεταφορών' },
                { value: '0613', label: '0613. Υπουργείο Ναυτιλίας & Νησιωτικής Πολιτικής' },
                { value: '0614', label: '0614. Υπουργείο Αγροτικής Ανάπτυξης &Τροφίμων' },
                { value: '0615', label: '0615. Υπουργείο Τουρισμού' },
                { value: '0616', label: '0616. Υπουργείο Κλιματικής Αλλαγής & Πολιτικής Προστασίας' },
                { value: '0617', label: '0617. Περιφέρειας Ανατολικής Μακεδονίας και Θράκης' },
                { value: '0618', label: '0618. Περιφέρειας Αττικής' },
                { value: '0619', label: '0619. Περιφέρειας Βορείου Αιγαίου' },
                { value: '0620', label: '0620. Περιφέρειας Δυτικής Ελλάδας' },
                { value: '0621', label: '0621. Περιφέρειας Δυτικής Μακεδονίας' },
                { value: '0622', label: '0622. Περιφέρειας Ηπείρου' },
                { value: '0623', label: '0623. Περιφέρειας Θεσσαλίας' },
                { value: '0624', label: '0624. Περιφέρειας Ιονίων Νήσων' },
                { value: '0625', label: '0625. Περιφέρειας Κεντρικής Μακεδονίας' },
                { value: '0626', label: '0626. Περιφέρειας Κρήτης' },
                { value: '0627', label: '0627. Περιφέρειας Νοτίου Αιγαίου' },
                { value: '0628', label: '0628. Περιφέρειας Πελοποννήσου' },
                { value: '0629', label: '0629. Περιφέρειας Στερεάς Ελλάδας' },
                { value: '0630', label: '0630. Αναπτυξιακό Πρόγραμμα Ειδικού Σκοπού Βορείου Αιγαίου' },
                { value: '0631', label: '0631. Αναπτυξιακό Πρόγραμμα Ειδικού Σκοπού Νοτίου Αιγαίου' },
                { value: '0632', label: '0632. Ειδικό Πρόγραμμα Δήμου Αθηναίων' },
                { value: '0633', label: '0633. Ειδικό Πρόγραμμα Φυσικών Καταστροφών' },
                { value: '0634', label: '0634. Ειδικό Πρόγραμμα Αντιμετώπισης Έκτακτων Αναγκών' },
                { value: '0699', label: '0699. Άλλο (διευκρινίστε στη στήλη ΠΑΡΑΤΗΡΗΣΕΙΣ)' }
            ],
            'epa_2021_2025': [
                { value: '0701', label: '0701. Smart Cities' },
                { value: '0702', label: '0702. Παρεμβάσεις με στόχο τη βελτίωση του Δημόσιου Χώρου' },
                { value: '0703', label: '0703. Αειφόρος χρήση των πόρων, ανθεκτικότητα στην κλιματική αλλαγή και διατήρηση της βιοοιποικιλότητας (Πράσινη Μετάβαση - Επεξεργασία Λυμάτων)' },
                { value: '0704', label: '0704. Βελτίωση οδικής ασφάλειας' },
                { value: '0705', label: '0705. Παρεμβάσεις αναβάθμισης περιφερειακών λιμένων' },
                { value: '0706', label: '0706. Στρατηγικές αστικές αναπλάσεις' },
                { value: '0707', label: '0707. Εκσυγχρονισμός των ΚΕΠ' },
                { value: '0708', label: '0708. Αειφόρος χρήση των πόρων, ανθεκτικότητα στην κλιματική αλλαγή και διατήρηση της βιοποικιλότητας (Ύδατα)' },
                { value: '0709', label: '0709. Αειφόρος χρήση των πόρων, ανθεκτικότητα στην κλιματική αλλαγή και διατήρηση της βιοποικιλότητας (Εθνικό Δίκτυο Μονοπατιών)' },
                { value: '0710', label: '0710. Βελτίωση της ενεργειακής απόδοσης σε εγκαταστάσεις οδοφωτισμού στους ΟΤΑ' },
                { value: '0799', label: '0799. Άλλο (διευκρινίστε στη στήλη ΠΑΡΑΤΗΡΗΣΕΙΣ)' }
            ],
            'tameio_anakampsis': [
                { value: '1001', label: '1001. Πράσινο Ταμείο' },
                { value: '1002', label: '1002. Ταμείο Αλληλεγγύης (Υπουργείου Μετανάστευσης και Ασύλου)' },
                { value: '1003', label: '1003. Ίδρυση νέων τμημάτων βρεφικής, παιδικής και βρεφονηπιακής φροντίδας' },
                { value: '1004', label: '1004. ΗΛΕΚΤΡΑ: Πρόγραμμα Ενεργειακής Αναβάθμισης Δημόσιων Κτιρίων (Υπουργείου Περιβάλλοντος και Ενέργειας)' },
                { value: '1005', label: '1005. Παραμένει κενό προς μελλοντική χρήση' },
                { value: '1006', label: '1006. Παραμένει κενό προς μελλοντική χρήση' },
                { value: '1007', label: '1007. Εκπόνηση Τοπικών Πολεοδομικών Σχεδίων (ΤΠΣ) (Υπουργείου Περιβάλλοντος και Ενέργειας)' },
                { value: '1099', label: '1099. ΙΔΙΟΙ ΠΟΡΟΙ' }
            ],
            'loipa_programmata': [
                { value: '9999', label: '9999. ΛΟΙΠΑ ΠΡΟΓΡΑΜΜΑΤΑ ή ΠΟΡΟΙ (διευκρινίστε στη στήλη ΠΑΡΑΤΗΡΗΣΕΙΣ)' }
            ]
        };
